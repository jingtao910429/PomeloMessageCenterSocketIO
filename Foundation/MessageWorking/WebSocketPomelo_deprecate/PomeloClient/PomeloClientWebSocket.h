 ...
 *  @param error  错误信息
 */
- (void)pomeloDisconnect:(PomeloClientWebSocket *)pomelo withError:(NSError *)error;
@end


@class ProtobufDecoder;
@class ProtobufEncoder;
@interface PomeloClientWebSocket : NSObject<SRWebSocketDelegate>{
